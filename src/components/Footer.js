      ...
      <div className="footer-content">
        <div className="footer-section">
          ...
          <div className="social-links">
            <a
              href="https://www.linkedin.com/company/cloudmosaic-co/"
              target="_blank"
            ...
            <a
              href="https://x.com/Cloud_Mosaic_25"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.instagram.com/cloud_mosaic_25?igsh=MWtpOWdzdzZ3ZnFmOQ=="
              target="_blank"
              rel="noopener noreferrer"
